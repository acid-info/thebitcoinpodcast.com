...
return!1}).hide();this.options.fullScreen||b(this.cssSelector.title).hide();b(this.cssSelector.playlist+" ul").empty();this._createItemHandlers();b(this.cssSelector.jPlayer).jPlayer(this.options)};jPlayerPlaylist.prototype={_cssSelector:{jPlayer:"#jquery_jplayer_1",cssSelectorAncestor:"#jp_container_1"},_options:{playlistOptions:{autoPlay:!1,loopOnPrevious:true,shuffleOnLoop:!0,enableRemoveControls:!1,displayTime:"slow",addTime:"fast",removeTime:"fast",shuffleTime:"slow",itemClass:"jp-playlist-item",
...
change:function(i){ var player=jQuery('.featured-player'); var button=player.find('.button-container'); if(player.find('.playlist a:eq('+i+')').attr('data-link')!='') { button.show().find('a.button').attr('href',jQuery('.playlist a:eq('+i+')').attr('data-link')); player.removeClass('with-button without-button').addClass('with-button');} else { button.hide(); player.removeClass('with-button without-button').addClass('without-button');; }}, next:function(){var a=this.current+1<this.playlist.length?this.current+1:0;this.change(a);this.loop?a===0&&this.shuffled&&this.options.playlistOptions.shuffleOnLoop&&this.playlist.length>1?this.shuffle(!0,!0):this.play(a):a>0&&this.play(a)},previous:function(){var a=this.current-1>=0?this.current-1:this.playlist.length-1;this.change(a);this.play(a)},shuffle:function(a,c){var d=this;a===f&&(a=!this.shuffled);(a||a!==this.shuffled)&&b(this.cssSelector.playlist+
